 <!DOCTYPE html>
    ...
    <div id="aa-preloader-area">
        <div class="mu-preloader">
            <img src="{{asset('assets/img/preloader.gif')}}" alt=" loader img">
        </div>
    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mu-about-us-right">
                                    <ul class="mu-abtus-slider">
                                        <li><img src="{{asset('assets/img/about-us/abtus-img-1.png')}}" alt="img"></li>
                                        <li><img src="{{asset('assets/img/about-us/abtus-img-2.png')}}" alt="img"></li>
                                        <li><img src="{{asset('assets/img/about-us/abtus-img-6.png')}}" alt="img"></li>
                                        <li><img src="{{asset('assets/img/about-us/abtus-img-4.png')}}" alt="img"></li>
                                        <li><img src="{{asset('assets/img/about-us/abtus-img-5.png')}}" alt="img"></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <ul class="mu-menu-item-nav">
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-1.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-2.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                    ...
                                                    <ul class="mu-menu-item-nav">
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-3.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">English Breakfast</a></h4>
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-4.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">Chines Breakfast</a></h4>
                                                    ...
                                                    <ul class="mu-menu-item-nav">
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-5.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">English Breakfast</a></h4>
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-6.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">Chines Breakfast</a></h4>
                                                    ...
                                                    <ul class="mu-menu-item-nav">
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-7.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">English Breakfast</a></h4>
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-8.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">Chines Breakfast</a></h4>
                                                    ...
                                                    <ul class="mu-menu-item-nav">
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-9.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">English Breakfast</a></h4>
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="{{asset('assets/img/menu/item-10.jpg')}}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">Chines Breakfast</a></h4>
                            ...
                            <div class="mu-gallery-body" id="mixit-container">
                                ...
                                <div class="mu-single-gallery col-md-4 mix food">
                                    <div class="mu-single-gallery-item">
                                        ...
                                        <div class="mu-single-gallery-info">
                                            <a href="{{asset('assets/img/gallery/big/1.jpg')}}" data-fancybox-group="gallery" class="fancybox">
                                                <img src="{{asset('assets/img/plus.png')}}" alt="plus icon img">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mu-single-gallery col-md-4 mix drink">
                                    <div class="mu-single-gallery-item">
                                        ...
                                        <div class="mu-single-gallery-info">
                                            <a href="{{asset('assets/img/gallery/big/2.jpg')}}" data-fancybox-group="gallery" class="fancybox">
                                                <img src="{{asset('assets/img/plus.png')}}" alt="plus icon img">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="mu-single-gallery col-md-4 mix restaurant">
                                    <div class="mu-single-gallery-item">
                                        ...
                                        <div class="mu-single-gallery-info">
                                            <a href="{{asset('assets/img/gallery/big/3.jpg')}}" data-fancybox-group="gallery" class="fancybox">
                                                <img src="{{asset('assets/img/plus.png')}}" alt="plus icon img">
                                            </a>
                                        </div>
                                    </div>
